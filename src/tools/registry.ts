...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    id: 'code-formatter',
    name: '代码格式化',
    description: 'JavaScript、TypeScript、CSS、SCSS、Less、HTML、Markdown、YAML、GraphQL 一键美化。',
    category: 'format',
    keywords: ['prettier', 'js', 'ts', 'css', 'scss', 'less', 'html', 'markdown', 'yaml', 'graphql', 'vue', 'beautify', '美化'],
    icon: FileCode2,
    featured: true,
  ...
  },
  {
    ...
    category: 'convert',
    keywords: ['json', 'typescript', 'interface', 'go', 'struct', 'java', 'class', 'rust', 'swift', 'kotlin', '类型'],
    icon: Sparkles,
    featured: true,
  ...
  },
  {
    ...
    category: 'convert',
    keywords: ['case', 'camel', 'pascal', 'snake', 'kebab', 'upper', 'lower', '大小写', '驼峰', '命名'],
    icon: CaseSensitive,
  ...
  },
  {
    ...
    category: 'encode',
    keywords: ['url', 'uri', 'encode', 'decode', 'encodeURIComponent', 'query', 'percent', '编码', '解析'],
    icon: Link2,
  ...
  // ───── 加密与安全 ─────
  {
    ...
    category: 'crypto',
    keywords: ['md5', 'sha1', 'sha256', 'sha512', 'sha3', 'crc32', 'hash', 'digest', 'checksum', '哈希', '摘要', '加密'],
    icon: Hash,
    featured: true,
  ...
  },
  {
    ...
    category: 'crypto',
    keywords: ['aes', 'des', '3des', 'tripledes', 'encrypt', 'decrypt', 'cbc', 'ecb', '加密', '解密'],
    icon: Lock,
  ...
  // ───── 网络与 API ─────
  {
    ...
    category: 'network',
    keywords: ['postman', 'http', 'api', 'rest', 'request', 'fetch', 'curl', '接口', '调试', 'jkts'],
    icon: Send,
    featured: true,
  ...
  },
  {
    id: 'mock-data',
    name: '假数据生成',
    description: '批量生成中文姓名、手机号、邮箱、地址、身份证号等测试数据，导出 JSON / CSV / SQL。',
    category: 'text',
