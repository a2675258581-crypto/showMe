...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    name: 'JWT 解析',
    description:
      '解码 JWT 的 Header 与 Payload，显示有效期倒计时，校验 HS/RS/PS/ES/EdDSA 签名，并可签发 HS256/384/512 令牌。',
    category: 'encode',
    keywords: [
      'jwt',
      'token',
  ...
  },
  {
    ...
    name: 'HMAC 签名',
    description:
      '使用密钥计算 HMAC-MD5 / SHA-1 / SHA-2 / SHA3-256 / SM3 签名，可校验签名并生成多语言代码。',
    category: 'crypto',
    keywords: [
      'hmac',
      'signature',
  ...
  },
  {
    ...
    name: 'AES / DES 加解密',
    description:
      'AES / DES / 3DES / RC4 / Rabbit 加解密，支持 CBC/ECB/CFB/OFB/CTR、多种填充、OpenSSL 兼容口令模式、Base64 与 Hex。',
    category: 'crypto',
    keywords: [
      'aes',
      'des',
